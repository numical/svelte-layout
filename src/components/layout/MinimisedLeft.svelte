<script>
    ...
    import { maximised, minimised, left } from '../../stores/panelPositions';
    ...
    $: visible = ($layout.panelPosition === minimised && $layout.restorePanelPosition === left) || ($layout.panelPosition === maximised);
